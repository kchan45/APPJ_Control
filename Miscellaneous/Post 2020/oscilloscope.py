...
READWAIT = 0.15#0.15 # wait time between oscilloscope read and write, seconds
...
def get_oscilloscope(opts):
    if opts.platform == 'visa':
        ...
        print("device info: {}".format(instr.query("*IDNp?")))
        ...
        if platform == 'visa':
            ...
            while len(rawdata) < DATALENGTH:
                try:
                    ...
                    #retad_from_channel(instr,platform,channel,preamble)
