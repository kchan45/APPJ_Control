...
V=3 #initial applied power/voltage
O=0
...
################################# Disturbance #################################
       ...
       # print(len(Ts_2d_out))
        ...
        x_now=NP.linspace(-13*1.44,13*1.44,26)+y_pos-1 #positions corresponding to current measurement        
        y_now=NP.linspace(13*2,-13*2,26)+x_pos  #positions corresponding to current measurement
        ...
        if int_flag==1:
            ...
            CEM2D=CEM2D+1.3*(0.98/60.0)*np.exp(np.multiply(0.6964,(Tshift2D-53)))
        ############### FEED FORWARD ####################################
  ...
  #      ff_d=NP.array([0])
        ...
        xk_ff=ff_a.dot(x0_ff)+ff_b.dot(r[0])
...
#        Kp1=4.6
        ...
        Kp=0.1883## for egg 5/11/2018
        Ki=0.0503

        Kp=3.2##glass lambda 1.5
        Ki=0.12

     #   Kp=4.099##glass lambda 1.5
     #   Ki=0.1709
...
#        Ki=0.009832
       ...
       # Ki=0.02047
        ...
        #if r[0]==0:
        #   Kp=5.787## glass avg lambda 1
        #   Ki=0.3213
        #elif r[0]==1:
        #   Kp=4.066##metal lambda 1
        #   Ki=0.1698
...
#        msg='{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f} \n'.format(*CEM)
        ...
        save_fl.write('{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f},{:6.2f}\n'.format(time.time(),Tset,Ts,Ts2,Ts3,P,Imax,Ip2p,O777,O845,N391,He706,sum_int,*U_m,q_o,D_c,x_pos,y_pos,T_emb,V,P_emb,Prms,Rdel,Is,sig,sig2,r[0],Tspec[0]*550,uk_ff,tm_el))
        save_fl.flush()
